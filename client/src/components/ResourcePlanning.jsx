        ...
        {activeTab === 'feed' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={() => navigate('/food')} className="bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-md transition duration-200">
                طلب علف جديد
              </button>
            </div>
        ...
        {activeTab === 'vaccine' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={() => navigate('/medication-requests')} className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md transition duration-200">
                طلب لقاحات جديدة
              </button>
            </div>
        ...
        {activeTab === 'workers' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <a href='/sign-up' className="bg-yellow-600 hover:bg-yellow-700 text-white py-2 px-4 rounded-md transition duration-200">
                تعيين عامل جديد
              </a>
            </div>
